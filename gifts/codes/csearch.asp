...
<form name="addform" action="l.asp?P=gifts&SP=search" method="post">
...
<%
   ...
   if(str!="") {
      obj.ClearAll();
      obj.NewQuery("SELECT * FROM gifts WHERE "+str+" ORDER BY DATE DESC");
      obj.NewTemplate(SitePath+"gifts\\tree.wet");
