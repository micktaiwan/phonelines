...
<tr><td>&nbsp;</td><td><input class="button" type="button" value="查詢" onclick="sendform_daily(document.getElementById('date').value,document.getElementById('zone').value,document.getElementById('type').value)"></td></tr>
</table>
</form>
<div id="status">&nbsp;</div>
