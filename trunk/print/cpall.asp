...
<%
   ...
   obj.NewQuery("SELECT visits.*,personnel.CODE FROM visits LEFT OUTER JOIN personnel ON visits.TEAM=personnel.TEAM WHERE "+str+cond1+" ORDER BY visits.TEAM");
   obj.NewTemplate(SitePath+"print\\pall.wet");
