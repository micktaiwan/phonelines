...
<%
   ...
   obj.NewQuery("SELECT visits.*, personnel.CODE FROM visits LEFT OUTER JOIN personnel ON visits.TEAM=personnel.TEAM WHERE (RESULT='竣工' OR RESULT='障礙' OR RESULT='修復')AND "+str+cond1+" ORDER BY visits.TEAM");
   obj.NewTemplate(SitePath+"print\\pcompleted.wet");
